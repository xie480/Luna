...
.cute-btn.danger { border-color: rgba(255,80,80,0.22); color: rgba(255,130,130,0.85); }
...
.btn-code-prefix { font-size: 10px; color: rgba(0,255,180,0.50); flex-shrink: 0; }
...
.msgbox-glow-border {
  ...
  background: linear-gradient(90deg,
    transparent 0%, rgba(0,220,255,0.18) 25%,
    rgba(180,100,255,0.18) 50%, rgba(255,160,210,0.18) 75%, transparent 100%);
...
.tooltip {
  ...
  color: rgba(255,255,255,0.85); font-size: 10px; white-space: nowrap;
  background: rgba(8,12,20,0.95); padding: 4px 10px; border-radius: 4px;
...
.loader-track { fill: none; stroke: rgba(0,220,255,0.08); stroke-width: 2.5; }
.loader-arc {
  fill: none; stroke: rgba(0,220,255,0.80); stroke-width: 2.5;
  stroke-linecap: round; stroke-dasharray: 28 60;
...
.send-btn-cute:hover:not(:disabled) {
  background: rgba(0,220,255,0.18); border-color: rgba(0,220,255,0.50);
  transform: scale(1.10); box-shadow: 0 0 14px rgba(0,220,255,0.22);
}
...
.css-chat-bubble {
  max-width: 300px; padding: 9px 15px 9px 12px;
  width: fit-content;
  ...
  line-height: 1.6; display: flex; align-items: center; gap: 8px;
  word-break: break-word;
  box-shadow: 0 2px 16px rgba(0,220,255,0.08), 0 0 0 1px rgba(0,220,255,0.06);
...
.css-chat-bubble.leaving {
  animation: bubbleOut 0.22s ease forwards;
}
@keyframes bubbleOut {
