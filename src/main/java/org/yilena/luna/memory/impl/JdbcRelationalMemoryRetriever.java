...
public class JdbcRelationalMemoryRetriever implements RelationalMemoryRetriever {
    ...
    public Map<String, Object> retrieve(String sessionId, String userInput) {
        ...
        result.put("semantic_facts", queryList(() -> runtimeReadMapper.selectRelationalSemanticFacts(sessionId)));
        result.put("episodes", queryList(() -> runtimeReadMapper.selectRelationalEpisodes(sessionId)));
        result.put("procedures", queryList(runtimeReadMapper::selectRelationalProcedures));
